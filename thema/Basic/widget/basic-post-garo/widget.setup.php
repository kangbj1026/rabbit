	...
	<tr>
		...
		<td>
			<select name="wset[irows]">
				<option value="30"<?php echo get_selected('30', $wset['irows']);?>>30개</option>
				<option value="20"<?php echo get_selected('20', $wset['irows']);?>>20개</option>
				<option value="10"<?php echo get_selected('10', $wset['irows']);?>>10개</option>
