			...
			<div class="pull-right">
				<ul>
					<?php if($is_member) { // 로그인 상태 ?>
						...
						<?php } ?>
						<!-- <li <?php echo ($member['response'] || $member['memo']) ? '' : ' style="display:none;"';?>>
							<a href="javascript:;" onclick="sidebar_open('sidebar-response');"> 
								알림 <b class="orangered sidebarCount"><?php echo $member['response'] + $member['memo'];?></b>
							</a>
						</li> -->
					<?php } else { // 로그아웃 상태 ?>
						<li><a href="<?php echo $at_href['login'];?>" > <!-- onclick="sidebar_open('sidebar-user'); return false;" -->
							<img src="<?php echo THEMA_URL;?>/img/login.png">
						</a></li>
						<li><a href="<?php echo $at_href['reg'];?>"><img src="<?php echo THEMA_URL;?>/img/join.png"></a></li>
					...
					<?php if($member['admin']) { ?>
						<a href="http://rabbit.dothome.co.kr/bbs/page.php?hid=intro"><img src="<?php echo THEMA_URL;?>/img/PAGE.png"></a>
					<?php } ?>
					<?php if($is_member) { ?>
						<li><a href="<?php echo $at_href['logout'];?>"><img class="logout" src="<?php echo THEMA_URL;?>/img/logout.png"></a></li>
					<?php } ?>
				</ul>
			</div>
		...
		<div class="at-container">
			...
			<div class="header-logo">
				<a href="<?php echo $at_href['home'];?>">
					<img src="<?php echo THEMA_URL;?>/img/rdp.png">
				</a>
		...
		<div class="at-container">
			<div class="header-wrap">
				<div class="header-icon">
					<?php if($is_member) { ?>
					<a class="logout" href="<?php echo $at_href['logout'];?>">
						<img src="<?php echo THEMA_URL;?>/img/logout.png">
					</a>
					<?php } else { ?>
					<a class="login" href="<?php echo $at_href['login'];?>" > <!-- onclick="sidebar_open('sidebar-user'); return false;" -->
						<img src="<?php echo THEMA_URL;?>/img/login.png">
					</a>
					<?php }
					if($member['admin']) { ?>
					<a class="m-page" href="http://rabbit.dothome.co.kr/bbs/page.php?hid=intro">
						<img src="<?php echo THEMA_URL;?>/img/PAGE.png" style="display:block;width:100%;margin:20%;">
					</a>
					<?php } ?>
				</div>
				<div class="header-logo">
			...
			<div class="at-container">
				<div class="nav-right nav-rw nav-height">
					<ul>
						...
						<li>
							<?php if($is_member) { ?>
							<a href="javascript:;" onclick="sidebar_open('sidebar-response');"<?php echo tooltip('정보');?>>
