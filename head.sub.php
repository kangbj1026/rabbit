...
// 카카오톡 링크 공유 시 썸네일 이미지 적용 
echo '<meta property="og:title" content="헤헷">';
echo "<meta property='og:image' content='".G5_IMG_URL."/pg.gif'>";
echo "<meta property='og:image:width' content='800'/>";
echo "<meta property='og:image:height' content='400'/>";
echo "<meta property='og:url' content='http://rabbit.dothome.co.kr/'/>";
echo "<meta property='og:site_name' content='어서와~'/> ";
echo "<meta property='og:type' content='website'/>";
// 적용 후 캐쉬 삭제 주소 https://developers.kakao.com/tool/clear/og
...
echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/page.css?ver='.APMS_SVER.'">'.PHP_EOL;
echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/swiper-bundle.min.css">'.PHP_EOL;
echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/video-js.css">'.PHP_EOL;
echo '<link rel="stylesheet" href="'.G5_CSS_URL.'/jquery-ui.css">'.PHP_EOL;
if($xp['xp_icon'] == 'txt') {
...
<script src="<?php echo G5_JS_URL ?>/video.min.js"></script>
<script src="<?php echo G5_JS_URL ?>/jquery-ui.js"></script>
<link rel="stylesheet" href="<?php echo G5_JS_URL ?>/font-awesome/css/font-awesome.min.css">
<link rel="shortcut icon" type="image/x-icon" href="<?php echo G5_IMG_URL ?>/w.png">
<?php
