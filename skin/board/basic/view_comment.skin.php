...
?>
	<aside id="bo_vc_w">
		<div class="print-hide panel" style="margin-top:10px;">
						...
						<div class="panel-body col-xs-6">
							<div class="form-group has-feedback">
								...
								<div class="col-sm-3 sec">
									<ol>
									<li><input type="checkbox" name="wr_secret" value="secret" id="wr_secret"> <label> 비밀글</label></li>
									<?php if($board['bo_use_sns'] && ($config['cf_facebook_appid'] || $config['cf_twitter_key'])) {	?>
									<?php } ?>
									</ol>
								</div>
								<div class="col-sm-3 s-btn">
									<div class="form-group">
										<div class="btn-group">
											<button class="btn btn-sm" type="submit" id="btn_submit"><b>등록</b></button>
											<button class="btn btn-sm" title="이모티콘" type="button" onclick="apms_emoticon();"> 이모티콘</button>
											<button class="btn btn-sm" title="새댓글" type="button" onclick="comment_box('','c');">답변 취소</button>
										</div>
									</div>	
								</div>
							</div>
