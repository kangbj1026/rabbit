...
<style>
/* search-modal */
/* 	.search-modal {display:flex;}
	.search-modal .form-group {width:50%;margin:0 0 0 auto;}
	.search-modal .btn-group {width:25%;margin:0 0 0 20px;} */
</style>
<section class="board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>"> 
	...
	<div class="list-wrap">
		<!-- 검색 -->
		<form name="fsearch search-modal" method="get" role="form" class="form search-modal" style="margin-top:20px;">
				...
				<?php if ($list_href || $write_href) { ?>
					<div class="form-group pull-right list-btn">
						<div class="btn-group dropup">
							...
							<?php if ($write_href && $member['mb_id']) { ?><a href="<?php echo $write_href ?>" class="btn btn-color btn-sm"><i class="fa fa-pencil"></i><span>글쓰기</span></a><?php } ?>
						</div>
					</div>
				<!-- RAND -->
				<?php } if($bo_table != "RAND") { ?>
