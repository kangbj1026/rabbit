...
<div class="panel panel-default">
	<div class="panel-heading t-c">
	<h4>
		<strong><i class="fa fa-birthday-cake fa-lg"></i>
		<strong><?php echo $mb['mb_name'] ?></strong>
		님의 회원가입을 진심으로 축하합니다.</strong>
	</h4>
	</div>
	<div class="panel-body">
		...
		<?php }  ?>
		<img src="<?php echo G5_IMG_URL."/pg.gif" ?>" class="fl-l">
		<span class="fl-r">
