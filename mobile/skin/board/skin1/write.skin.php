...
<section id="bo_w">
    ...
    <div class="frm_input full_input" style=padding:10px>
        <input type=radio name=wr_10 value="yes"<?php echo ($write['wr_10'] == "yes") ? " checked" : ""; ?> required> 자바스크립트
        <input type=radio name=wr_10 style=margin-left:5px value="no"<?php echo ($write['wr_10'] == "no") ? " checked" : ""; ?> required> 본문사용
    </div>
