...
define('G5_PAGE_DIR',     'page');
define('G5_LIST_DIR',     'list');
...
define('G5_PAGE_URL',     G5_URL.'/'.G5_PAGE_DIR);
define('G5_LIST_URL',     G5_URL.'/'.G5_LIST_DIR);
...
define('G5_PAGE_PATH',		G5_PATH.'/'.G5_PAGE_DIR);
define('G5_LIST_PATH',		G5_PATH.'/'.G5_LIST_DIR);
